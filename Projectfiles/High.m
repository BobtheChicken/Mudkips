...
-(id) init
{
    if ((self = [super init]))
    {
        ...
        CCLabelBMFont *highScoreLabel = [CCLabelTTF labelWithString:highScoreString fontName:@"Bend2SquaresBRK" fontSize:20];
        ...
        */
        ...
        CCLabelBMFont *lastRoundPlayed = [CCLabelTTF labelWithString:lastRoundString fontName:@"Bend2SquaresBRK" fontSize:20];
